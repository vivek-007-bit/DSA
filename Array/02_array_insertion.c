/*This program illustrates the usage of array as an Abstract Data Type
  as well how to insert a particular element at a given index.
  The insertion works by shifting all the elements for creating
  the space for the newly inserted element*/
